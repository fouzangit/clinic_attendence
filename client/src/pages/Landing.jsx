    ...
    <div className="min-h-screen bg-[#f4f7fe] flex flex-col items-center justify-center p-6 text-[#2c3e50] overflow-hidden">
      ...
      <div className="max-w-7xl w-full text-center space-y-16 py-12">
        <div className="animate-in fade-in slide-in-from-top duration-1000">
          <div className="bg-blue-900/40 backdrop-blur-xl border-2 border-blue-400/30 p-12 rounded-[60px] shadow-2xl inline-block max-w-5xl mx-auto">
            ...
            <p className="text-3xl text-blue-50 font-medium max-w-3xl mx-auto opacity-95 leading-relaxed mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12 px-4 max-w-5xl mx-auto">
          ...
          <Link 
            to="/login"
            className="group bg-white p-12 rounded-[60px] shadow-2xl hover:translate-y-[-15px] transition-all duration-500 border-b-8 border-indigo-600 flex flex-col items-center text-center space-y-8"
          >
            ...
            <div>
              <h2 className="text-4xl font-black mb-3 text-indigo-900 uppercase tracking-tight">Admin Portal</h2>
          ...
          >
            ...
            <div>
              <h2 className="text-4xl font-black mb-3 text-blue-900 uppercase tracking-tight">Staff Portal</h2>
